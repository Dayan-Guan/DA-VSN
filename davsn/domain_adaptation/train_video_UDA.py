...
def train_DAVSN(model, trainloader, targetloader, cfg):
    ...
    for i_iter in tqdm(range(cfg.TRAIN.EARLY_STOP + 1)):
        ...
        pred_trg_aux, pred_trg, pred_trg1, pred_trg_aux1, pred_trg2, pred_trg_aux2 = model(image.cuda(device), image2.cuda(device), flow, device)
        ...
        if cfg.TRAIN.MULTI_LEVEL:
            ...
            loss_tim_aux = 0
        loss = (cfg.TRAIN.lamda_u * loss_tim + cfg.TRAIN.lamda_u * aux_factor * loss_tim_aux)
        ...
        if cfg.TRAIN.MULTI_LEVEL:
            ...
            loss_dis_aux = 0
        loss = (cfg.TRAIN.lamda_u * cfg.TRAIN.lamda_wd * loss_dis
                + cfg.TRAIN.lamda_u * cfg.TRAIN.lamda_wd * loss_dis_aux)
        loss.backward()
